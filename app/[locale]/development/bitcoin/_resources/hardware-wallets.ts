...
export const hardwareWalletsEn: BitcoinDevResources["hardware-wallets"] = [
  {
    name: "Cold Card",
    description:
    ...
    logo: "https://coldcard.com/static/images/logo.svg",
  },
  {
...
export const hardwareWalletsKo: BitcoinDevResources["hardware-wallets"] = [
  {
    name: "Cold Card",
    description:
      "보안과 오픈소스 소프트웨어에 중점을 둔 하드웨어 지갑으로, 비트코인의 콜드 스토리지를 위해 설계되었습니다.",
    url: "https://coldcard.com",
    logo: "https://coldcard.com/static/images/logo.svg",
  },
  {
