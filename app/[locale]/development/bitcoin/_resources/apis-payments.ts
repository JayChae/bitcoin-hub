...
export const apisPaymentsKo: BitcoinDevResources["apis-payments"] = [
  {
    name: "BTCPay Server",
    description:
      "비트코인 결제를 받을 수 있는 오픈소스 자체 호스팅 결제 프로세서.",
    url: "https://btcpayserver.org",
    logo: "https://avatars.githubusercontent.com/u/31132886?s=200&v=4",
  },
  {
    name: "Cyphernode",
    description:
      "도커화된 비트코인 및 암호화폐 소프트웨어 프로젝트의 암호화된 오버레이 네트워크를 생성하고 호출할 수 있는 오픈소스 자체 호스팅 API.",
    url: "https://github.com/SatoshiPortal/cyphernode",
    logo: "https://avatars.githubusercontent.com/u/21064192?s=200&v=4",
  },
  {
    name: "OpenNode",
    description:
      "비즈니스와 개발자들이 애플리케이션 내에서 비트코인과 라이트닝 네트워크 결제를 원활하게 받을 수 있도록 하는 간단하고 강력한 REST API.",
    url: "https://www.opennode.com",
    logo: "https://opennode.com/_nuxt/img/logo-footer.500b435.svg",
  },
  {
