...
export const notesDocsEn: DevResource[] = [
  ...
  {
    name: "Web BTC",
    description: "Technical resource platform for Bitcoin development.",
    url: "https://webbtc.dev",
    logo: "",
  },
];
...
export const notesDocsKo: DevResource[] = [
  ...
  },
  {
    name: "BitcoinBook.dev",
    description:
      "비트코인 개발 학습 돕는 상세한 설명과 예제 제공 오픈소스 프로젝트.",
    url: "https://bitcoinbook.dev",
    logo: "",
  },
  {
  ...
  {
    name: "Web BTC",
    description: "비트코인 개발 기술 리소스 플랫폼.",
    url: "https://webbtc.dev",
    logo: "",
  },
];
